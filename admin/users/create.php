...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        VALUES (NULL,'$name', '$username', '$password', '$image', '$address', '$email', '$phone', '$status', '$role ');";
    ...
    <div class="create_user">
        <form action="" method="POST" class="user__form" enctype="multipart/form-data">
            ...
            <div class="user__lable">
                ...
                <input placeholder="Tình trạng..." type="text" name="status" class="user__form-address" required>
            </div>
            <div class="user__lable">
                <label class="user__lable-name" for="">Vai trò:</label>
                <input placeholder="Vai trò..." type="text" name="role" class="user__form-address" required>
            </div>
